 ...
 * @author usuario
 */
public class IUPunto41 extends javax.swing.JFrame {

    /**
     * Creates new form IUPunto41
     */
    public IUPunto41() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("conjunto de datos positivos separados por coma:");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(123, 123, 123)
                        .addComponent(TxtListaNumeros, javax.swing.GroupLayout.PREFERRED_SIZE, 368, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(275, 275, 275)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            ArrayList<Double> listaNumerosDouble = new ArrayList<>();
            
            listaNumerosString.forEach(s -> {
                listaNumerosDouble.add(Double.parseDouble(s));
            });
            
            Collections.sort(listaNumerosDouble);
            
            this.LblResultado.setText(listaNumerosDouble.get(listaNumerosDouble.size() - 1).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IUPunto41.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
